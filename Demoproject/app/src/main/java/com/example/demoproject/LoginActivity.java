                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Intent intent = new Intent(LoginActivity.this, InsuranceServiceActivity.class);
                            Log.d(TAG, "Starting InsuranceServiceActivity...");
                            startActivity(intent);
                            Log.d(TAG, "InsuranceServiceActivity started.");
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.e(TAG, "JSON exception: " + e.getMessage());
                        }
